...
void server_user_t::push(const QByteArray& m)
{
  impl->push(m);
}

QByteArray server_user_t::pull()
{
  return impl->pull();
}

bool server_user_t::is_empty() const
{
...
void server_user_t::add_receive_serial_num()
{
...
void server_user_t::impl_t::push(const QByteArray& m)
{
  messages.append(m);
}

QByteArray server_user_t::impl_t::pull()
{
...
bool server_user_t::impl_t::is_empty() const
{
...
void server_user_t::impl_t::add_receive_serial_num()
{
  ++receiv_serial_num;
}
