#include "logic/handle_message.hpp"
...
template<>
void message_handler_t::handle_fn<msg::login_t>(const std::string& message, player_t& player)
{
...
template<>
void message_handler_t::handle_fn<msg::opponent_inf_t>(const std::string& message, player_t& player)
{
...
template<>
void message_handler_t::handle_fn<msg::my_inf_t>(const std::string& message, player_t& player)
{
...
template<>
void message_handler_t::handle_fn<msg::client_lost_t>(const std::string& message, player_t& player)
{
...
template<>
void message_handler_t::handle_fn<msg::move_t>(const std::string& message, player_t& player)
{
...
template<>
void message_handler_t::handle_fn<msg::back_move_t>(const std::string& message, player_t& player)
{
...
template<>
void message_handler_t::handle_fn<msg::go_to_history_t>(const std::string& message, player_t& player)
{
...
template<>
void message_handler_t::handle_fn<msg::new_game_t>(const std::string& message, player_t& player)
{
...
void message_handler_t::start_new_game(player_t& player)
{
...
void message_handler_t::board_updated(player_t& player)
{
  const auto board_uuid = games_manager_.board(player);
  if (!board_uuid)
  {
